# Generated by Django 3.2.13 on 2022-06-21 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, max_length=150, null=True, verbose_name='пол')),
                ('age', models.CharField(blank=True, max_length=150, null=True, verbose_name='возраст')),
                ('interests', models.CharField(blank=True, max_length=150, null=True, verbose_name='интересы')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='accounts', to=settings.AUTH_USER_MODEL, verbose_name='имя пользователя')),
            ],
            options={
